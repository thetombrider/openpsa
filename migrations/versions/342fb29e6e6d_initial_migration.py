...
def upgrade() -> None:
    ...
    userrole = sa.Enum("ADMIN", "MANAGER", "CONSULTANT", name='userrole')
    projectstatus = sa.Enum("DRAFT", "ACTIVE", "COMPLETED", "CANCELLED", name='projectstatus')
    resourceallocationstatus = sa.Enum("PLANNED", "ACTIVE", "COMPLETED", name='resourceallocationstatus')
    billingtype = sa.Enum("TIME_AND_MATERIALS", "FIXED_PRICE", name='billingtype')
